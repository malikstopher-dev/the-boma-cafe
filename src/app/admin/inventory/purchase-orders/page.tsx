...
export default function PurchaseOrdersPage() {
  ...
  return (
    <AdminPage
      ...
      actions={<Link href="/admin/inventory/purchase-orders/new"><Button size="sm">New PO</Button></Link>}
      filters={
        <FilterBar>
    ...
    >
      <DataTable<PurchaseOrder>
        ...
        data={filtered}
        keyField="id"
        onRowClick={po => router.push(`/admin/inventory/purchase-orders/${po.id}`)}
        isLoading={isLoading}
        emptyState={
