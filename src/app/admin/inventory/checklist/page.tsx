...
export default function OpeningChecklistPage() {
  ...
  return (
    <AdminPage
      ...
      subtitle={checklist ? new Date(checklist.checklist_date).toLocaleDateString('en-ZA', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) : ''}
      actions={
        <div className="flex gap-2">
          ...
          <Link href="/admin/inventory/checklist/history" className="text-sm text-brand-400 hover:underline self-center">
            History
          </Link>
        </div>
      }
