          ...
          {!purchaseOrders || (purchaseOrders.overdue.length === 0 && purchaseOrders.recent.length === 0) ? (
            ...
            <div className="space-y-2 max-h-64 overflow-y-auto">
              {purchaseOrders.overdue.length > 0 && (
                <div>
                  ...
                  {purchaseOrders.overdue.map(po => (
                    <a key={po.id} href={`/admin/inventory/purchase-orders/${po.id}`} className="flex items-center justify-between text-sm p-2 bg-red-50 rounded mb-1 hover:bg-red-100">
              ...
              {purchaseOrders.recent.map(po => (
                <a key={po.id} href={`/admin/inventory/purchase-orders/${po.id}`} className="flex items-center justify-between text-sm p-2 bg-gray-50 rounded hover:bg-gray-100">
                  <span className="truncate flex-1">{po.supplierName}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg border p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link href="/admin/inventory/products"><Button variant="secondary" size="sm">Products</Button></Link>
            <Link href="/admin/inventory/transactions"><Button variant="secondary" size="sm">Transactions</Button></Link>
            <Link href="/admin/inventory/imports"><Button variant="secondary" size="sm">Imports</Button></Link>
            <Link href="/admin/inventory/reports"><Button variant="secondary" size="sm">Reports</Button></Link>
            <Link href="/admin/inventory/purchase-orders"><Button variant="secondary" size="sm">Purchase Orders</Button></Link>
          </div>
        </div>
      </div>
    </AdminPage>
