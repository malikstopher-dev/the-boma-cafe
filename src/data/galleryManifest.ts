...
export const galleryImages: Record<string, GalleryImage[]> = {
  ...
  food: [
    ...
    { url: '/gallery/food/img-7418-1152x647.jpeg', alt: 'Main course' },
    { url: '/gallery/food/img-7436-1152x647.jpeg', alt: 'Plated meal' },
    { url: '/gallery/food/2023-10-02.webp', alt: 'Food special' },
  ...
  venue: [
    ...
    { url: '/gallery/venue/bomacafe4-large-1.jpg', alt: 'Firepit view' },
  ...
  people: [
    ...
    { url: '/gallery/people/bomacafe2-large-1.jpg', alt: 'Table setting' },
  ...
  promotions: [
    ...
    { url: '/gallery/promotions/2025-04-23-1.webp', alt: 'April special' },
    { url: '/gallery/promotions/2025-04-23-1b.jpg', alt: 'Promo image' },
    ...
    { url: '/gallery/promotions/2026-03-27-9.webp', alt: 'March deal' },
    { url: '/gallery/promotions/2026-04-05.webp', alt: 'April deal' },
    { url: '/gallery/promotions/2026-04-08.webp', alt: 'Latest promotion' },
    { url: '/gallery/promotions/2026-04-08-2.webp', alt: 'April special' },
    { url: '/gallery/promotions/2026-04-08-4.webp', alt: 'Weekend offer' },
  ],
};
