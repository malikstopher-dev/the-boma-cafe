...
export const galleryImages: Record<string, GalleryImage[]> = {
  events: [
    ...
    { url: '/gallery/events/2026-03-27%20(1).webp', alt: 'Event venue' },
    { url: '/gallery/events/2026-03-31%20(1).webp', alt: 'Special event' },
  ],
  food: [
    { url: '/gallery/food/gallery-1-800x600.jpeg', alt: 'Signature dish' },
    { url: '/gallery/food/gallery-2-800x600.jpeg', alt: 'Appetizer' },
    { url: '/gallery/food/img-7418-1152x647.jpeg', alt: 'Signature dish' },
    { url: '/gallery/food/img-7436-1152x647.jpeg', alt: 'Plated meal' },
  ...
  venue: [
    ...
    { url: '/gallery/venue/bomacafe4_large%20(1).jpg', alt: 'Firepit area' },
    ...
    { url: '/gallery/venue/gallery-8-800x600.jpeg', alt: 'Interior' },
  ],
  people: [
    ...
    { url: '/gallery/people/bomacafe2_large%20(1).jpg', alt: 'Table setting' },
    { url: '/gallery/people/gallery-7-800x600.jpeg', alt: 'Group gathering' },
    { url: '/gallery/people/2026-04-08%20(3).webp', alt: 'Celebration' },
    { url: '/gallery/people/2026-04-08%20(5).webp', alt: 'Special occasion' },
  ],
  promotions: [
    { url: '/gallery/promotions/2024-07-31.jpg', alt: 'Special offer' },
    { url: '/gallery/promotions/2025-04-23.jpg', alt: 'Promotion' },
    { url: '/gallery/promotions/2025-04-23%20(1).webp', alt: 'April special' },
    ...
    { url: '/gallery/promotions/2026-03-27%20(8).webp', alt: 'Weekend special' },
    { url: '/gallery/promotions/2026-03-27%20(9).webp', alt: 'March special' },
    { url: '/gallery/promotions/2026-04-05.webp', alt: 'April special' },
    { url: '/gallery/promotions/2026-04-08.webp', alt: 'Latest promotion' },
    { url: '/gallery/promotions/2026-04-08%20(2).webp', alt: 'April deal' },
    { url: '/gallery/promotions/2026-04-08%20(4).webp', alt: 'Weekend offer' },
  ],
};
